...
subprocess.call("fvctl -f /dev/null add-flowspace s1-port2-video 1 100 in_port="+num+" video=7", shell=True)
...
subprocess.call("fvctl -f /dev/null add-flowspace s4-port2-video 4 100 in_port="+num+" video=7", shell=True)


num = get_sw_port_number('s1', 's2')
subprocess.call("fvctl -f /dev/null add-flowspace s-port1-non-video 1 1 in_port="+num+" non-video=7", shell=True)
...
subprocess.call("fvctl -f /dev/null add-flowspace s4-port1-non-video 4 1 in_port="+num+" non-video=7", shell=True)
