...
subprocess.call("fvctl -f /dev/null add-flowspace s1-port1 1 1 in_port="+num+" upper=7", shell=True)
...
subprocess.call("fvctl -f /dev/null add-flowspace s4-port1 4 1 in_port="+num+" upper=7", shell=True)
...
subprocess.call("fvctl -f /dev/null add-flowspace s1-port2 1 1 in_port="+num+" lower=7", shell=True)
...
subprocess.call("fvctl -f /dev/null add-flowspace s4-port2 4 1 in_port="+num+" lower=7", shell=True)
